...
package com.diaoling.deobfuscator.config;
...
import com.diaoling.deobfuscator.transformers.DelegatingTransformer;
...
public class TransformerConfigDeserializer extends JsonDeserializer<TransformerConfig> {
    ...
    private TransformerConfig getById(JsonParser p, DeserializationContext ctxt, String id) throws JsonMappingException {
        Class<?> clazz = null;
        try {
            clazz = Class.forName("com.diaoling.deobfuscator.transformers." + id);
        ...
        if (clazz != null) {
            if (Transformer.class.isAssignableFrom(clazz)) {
                ...
                throw ctxt.weirdStringException(id, Transformer.class, "Class does not extend com.diaoling.deobfuscator.transformers.Transformer");
            }
        } else {
