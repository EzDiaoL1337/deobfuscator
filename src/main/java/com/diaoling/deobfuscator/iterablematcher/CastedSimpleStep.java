...
public class CastedSimpleStep<T extends AbstractInsnNode> extends IterableStep<T> {

    private final int[] opcodes;

    public CastedSimpleStep(int... opcodes) {
        this.opcodes = opcodes;
    }

    public static <T extends AbstractInsnNode> CastedSimpleStep<T> ofOpcodeRangeInclusive(int start, int end) {
        ...
        return new CastedSimpleStep<T>(arr);
    }

    public static <T extends AbstractInsnNode> CastedSimpleStep<T> ofOpcodeRangeInclusive(int start, int end, int[] additional) {
        Validate.isTrue(start < end, "start opcode %s not smaller than end opcode %s", start, end);
