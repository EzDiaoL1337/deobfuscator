...
package com.diaoling.deobfuscator.rules.allatori;
...
import com.diaoling.deobfuscator.transformers.allatori.string.StringEncryptionTransformer;
...
public class RuleStringDecryptor implements Rule {
        ...
        for (ClassNode classNode : deobfuscator.getClasses().values()) {
            for (MethodNode methodNode : classNode.methods) {
                ...
                for (AbstractInsnNode ain : TransformerHelper.instructionIterator(methodNode)) {
                    ...
                    if (!com.diaoling.deobfuscator.transformers.allatori.StringEncryptionTransformer.isAllatoriMethod(decryptorNode)) {
                        continue;
                    }
    ...
    public Collection<Class<? extends Transformer<?>>> getRecommendTransformers() {
        return Arrays.asList(com.diaoling.deobfuscator.transformers.allatori.StringEncryptionTransformer.class, StringEncryptionTransformer.class);
    }
}
