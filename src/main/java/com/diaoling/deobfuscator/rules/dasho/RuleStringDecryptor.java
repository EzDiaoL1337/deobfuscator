...
package com.diaoling.deobfuscator.rules.dasho;
...
import com.diaoling.deobfuscator.transformers.dasho.StringEncryptionTransformer;
...
public class RuleStringDecryptor implements Rule {
    ...
    public Collection<Class<? extends Transformer<?>>> getRecommendTransformers() {
        return Arrays.asList(StringEncryptionTransformer.class,
        	com.diaoling.deobfuscator.transformers.dasho.string.StringEncryptionTransformer.class);
    }
}
